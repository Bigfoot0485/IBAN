...
1.0.0  fixed bug, which occured determining an IBAN of german rule 002000 to be valid

Roadmap
------------------------
~~1.0.0  Validates all IBANs, incl. all special rules for IBANs of Germany according to the publicated rules from July 2013~~
1.1.0  Update of the German rules to match the latest ones
1.2.0  Returns the BIC of German finance institutes
1.3.0  Implements a cache, which speeds up the process especially for batch processes
1.3.1  Allow formated IBANs to be passed and to be return
1.4.0  Returns details of the finance institute, like Name or PLZ
1.4.1  Add a validation for the account's checksum, which should also be part of the standard rule
1.4.2  Add PHPDoc for easier development
1.4.3  Implements detailled logging states
